...
class Container
{
    ...
    public function addDefinitions(array $newDefinitions)
    {
        ...
        // $this->definitions = array_merge($this->definitions,$newDefinitions); works too but
    ...
    public function resolve(string $className)
    {
        ...
        foreach ($params as $param) {
            ...
            if (!$type instanceof ReflectionNamedType || $type->isBuiltin()) {
                throw new ContainerException("Failed to resolve class{$className} because of invalid paran name.");
            }
